...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        ...
        new WeatherDataTask().execute(preferredLocation);
    }
    ...
    private class WeatherDataTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String jsonResponseFromServer = NetworkUtils.getResponseFromHttpUrl(weatherUrl);

                String[] weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson
                        (MainActivity.this, jsonResponseFromServer);
                return weatherData;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
